...
{
	internal class KalmanFilterVector2 : KalmanFilterBase<Vector2>
	{
		internal static KalmanFilterVector2 Build(float q, float r, float p) => new(q, r, p);
	    
		private KalmanFilterVector2(float q, float r, float p) : base(q, r, p) { }
